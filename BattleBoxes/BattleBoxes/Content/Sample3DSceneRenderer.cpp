...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	auto createAssetsTask = createPipelineStateTask.then([this]() {
		...
		{
			{ XMFLOAT3(-5.0f, -5.0f, -05.0f), XMFLOAT3(0.0f, 0.0f, 0.0f) },
			{ XMFLOAT3(-5.0f, -5.0f,  5.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
			{ XMFLOAT3(-5.0f,  5.0f, -5.0f), XMFLOAT3(0.0f, 1.0f, 0.0f) },
			{ XMFLOAT3(-5.0f,  5.0f,  5.0f), XMFLOAT3(0.0f, 1.0f, 1.0f) },
			{ XMFLOAT3(5.0f, -5.0f, -5.0f), XMFLOAT3(1.0f, 0.0f, 0.0f) },
			{ XMFLOAT3(5.0f, -5.0f,  5.0f), XMFLOAT3(1.0f, 0.0f, 1.0f) },
			{ XMFLOAT3(5.0f,  5.0f, -5.0f), XMFLOAT3(1.0f, 1.0f, 0.0f) },
			{ XMFLOAT3(5.0f,  5.0f,  5.0f), XMFLOAT3(1.0f, 1.0f, 1.0f) },
		};
...
void Sample3DSceneRenderer::CreateWindowSizeDependentResources()
{
  ...
  XMMATRIX perspectiveMatrix = XMMatrixOrthographicLH(viewport.Width, viewport.Height, -1000.0, 1000.0);
...
void Sample3DSceneRenderer::Rotate(float radians)
{
  ...
  float scaling = 40.0;
  XMStoreFloat4x4(&m_constantBufferData.model, XMMatrixMultiply(XMMatrixScaling(scaling, scaling, scaling), XMMatrixRotationY(radians)));
}
